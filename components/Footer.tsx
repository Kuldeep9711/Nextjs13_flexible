...
const Footer = () => {
  return (
    <footer className='flex flex-col paddings w-full gap-20 bg-light-white'>
      ...
      <div className=" flex-between footer_copyrights">
        <p>@ 2026 Flexibble. All rights reserved</p>
